...
globalkeys = my_table.join(
    ...
    awful.key({ }, "XF86MonBrightnessUp", function () beautiful.backlight.adjust("+1%") end, {description = "+1%", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () beautiful.backlight.adjust("1%-") end, {description = "-1%", group = "hotkeys"}),
    awful.key({ }, "XF86AudioRaiseVolume", function () beautiful.volume.adjust("1%+") end),
    awful.key({ }, "XF86AudioLowerVolume", function () beautiful.volume.adjust("1%-") end),
    awful.key({ }, "XF86AudioMute", function () beautiful.volume.toggle() end, {description = "toggle output mute", group = "hotkeys"}),
